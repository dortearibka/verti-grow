...
export default function VideoPupukKompos() {
  return (
    <section className="container flex flex-col justify-center items-center gap-8 py-16 px-4">
      ...
      width="900" 
      height="500" 
      src="https://www.youtube.com/embed/8jC8krdIjus?si=Op2gcGNPDMOoa060" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" 
      ...
      <div className="text-center max-w-2xl">
        ...
        <p className="mt-4 text-gray-600 text-lg">
          Dengan langkah-langkah ini, Anda dapat mengolah sampah organik menjadi pupuk kompos.
        </p>
      </div>
    </section>
  );
