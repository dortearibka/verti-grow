...
export default function VideoKomposDaun() {
  return (
    <section className="container flex flex-col justify-center items-center gap-8 py-16 px-4">
      ...
      width="900" 
      height="500" 
      src="https://www.youtube.com/embed/YRHcpHWtf6A?si=GKR0w6BTnWM1vUV8" title="YouTube video player" frameborder="0" 
      ...
      <div className="text-center max-w-2xl">
        <h3 className="text-3xl font-semibold text-gray-800 hover:text-green-600 transition-colors duration-300">
          Video Tutorial Pengolahan Sampah Daun Kering
        </h3>
        <p className="mt-4 text-gray-600 text-lg">
          Dengan langkah-langkah ini, Anda dapat mengolah sampah daun kering menjadi kompos.
        </p>
      </div>
    </section>
  );
