...
export default function VideoBawang() {
  return (
    <section className="container flex flex-col justify-center items-center gap-8 py-16 px-4">
      ...
      width="900" 
      height="500" 
      src="https://www.youtube.com/embed/CNQwwvpHAHw?si=AeZJfvF8jQjmrW6o" title="YouTube video player" frameborder="0" 
      ...
      <div className="text-center max-w-2xl">
        <h3 className="text-3xl font-semibold text-gray-800 hover:text-green-600 transition-colors duration-300">
          Video Tutorial Penanaman Daun Bawang
        </h3>
        <p className="mt-4 text-gray-600 text-lg">
          Dengan langkah-langkah ini, Anda dapat menanam daun bawang secara efektif
